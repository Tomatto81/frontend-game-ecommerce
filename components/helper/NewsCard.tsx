    ...
    <>
      ...
      <div className="col-span-4">
        ...
        <div className="text-white mb-[1rem]">
          ...
          repellendus illum nemo sed non quos ipsam. Voluptatum eaque tenetur
          deleniti, nulla sequi maiores? Enim fugiat asperiores nostrum vel nisi
          delectus?
        </div>
        <button className="before:ease bg-white text-[17px] relative h-10 w-36 overflow-hidden border border-black shadow-2x1 before:absolute before:left-0 before:-ml-2 before:h-48 before:w-48 before:origin-top-right before:-translate-x-full before:translate-y-12 before:-rotate-90 before:bg-blue-900 before:transition-all before:duration-300 hover:text-white hover:shadow-black hover:before:-rotate-180">
