  ...
  return (
    <div className="relative w-[100vw] h-[60vh] md:h-[87vh] bg">
      <div className="w-[90%] md:w-[80%] mx-auto h-[100%] flex flex-col items-start justify-center">
        ...
        <p
          data-aos="fade-left 200"
          className="text-white text-[14px] md:text-[18px] w-[90%] lg:w-[55%] mt-[1rem] md:mt-[0.2rem] mb-[1rem] oppacity-75"
        >
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Atque
          dolorem illum asperiores unde earum distinctio, nisi modi! Quisquam
          placeat modi ut numquam temporibus, dolores aperiam! Atque distinctio
          velit pariatur autem.
        </p>
